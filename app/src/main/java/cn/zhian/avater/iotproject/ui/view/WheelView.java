...
public class WheelView extends View {
    ...
    private void drawLine(Canvas canvas) {
        ...
        int startX = getWidth() / 2 - 60;
        int endX = getWidth() / 2 + 60;
        canvas.drawLine(startX, controlHeight / 2 - unitHeight / 2 + lineHeight,
                endX, controlHeight / 2 - unitHeight / 2 + lineHeight, linePaint);
        canvas.drawLine(startX, controlHeight / 2 + unitHeight / 2 - lineHeight,
                endX, controlHeight / 2 + unitHeight / 2 - lineHeight, linePaint);
    }
