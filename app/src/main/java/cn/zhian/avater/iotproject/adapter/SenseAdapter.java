 ...
 * @Description:
 */
public class SenseAdapter extends RecyclerView.Adapter<SenseAdapter.ViewHolder> {

    private Context mContext;
    private List<AddHomeBean> mDatas;

    public SenseAdapter(Context mContext, List<AddHomeBean> mDatas) {
    ...
    @NonNull
    @Override
    public SenseAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SenseAdapter.ViewHolder holder, int position) {
